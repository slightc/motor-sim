...
V_DC = 48.0                     # 母线电压(留足裕度，避免弱磁/电压饱和的极限环纹波)
...
T_END = 0.30
SPD_LO, SPD_HI = 30.0, 60.0     # 速度阶跃：30 -> 60 rad/s
T_STEP = 0.15                   # 阶跃时刻
T_LOAD = 0.30                   # 恒定负载转矩 (N·m)
...
fig.suptitle("Sensored FOC with SVPWM Inverter — Waveform Observation", fontsize=17, fontweight="bold")
...
ax.plot(td, idr[::D], "m--", lw=1.6, label="i_d ref (MTPA)")
